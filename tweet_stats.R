...
## @knitr splot
sentiment_plot <- ggplot(sentiment, aes(date)) + opts(title="Sentiment of tweets under #ESA2012 hashtag")
sentiment_plot +  geom_line(aes(y=positive_sentiment), colour="#18699c") +  geom_line(aes(y=negative_sentiment), colour="#a32e3a") + ylab("Count") + xlab("Time")
